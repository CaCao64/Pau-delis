...
| **BUS-28** | 🐛 Bug | Bug général d'affichage / crash ponctuel | Non | Plusieurs fragments | en cours | Diagnostic et correction selon les logs de crash. |
...
| **BUS-37** | 📖 Story | Ajouter bandeau d'information en ligne CE | **Oui** | `LinesFragment.kt`, `LineDetailFragment.kt` | en cours | Composant Marquee / Banner affichant les perturbations du réseau envoyées par l'API (En attente de capture d'écran). |
...
| **BUS-40** | 🐛 Bug | Le bus ne passe pas sur la route CE | **Oui** | `LineMapFragment.kt`, `AppData.kt` | en cours | Corriger les coordonnées GPS du tracé de ligne pour coller au réseau routier OSM (En attente de capture d'écran). |
